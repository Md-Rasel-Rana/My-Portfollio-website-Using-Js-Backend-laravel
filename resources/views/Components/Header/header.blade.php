<nav class="navbar navbar-expand-lg navbar-dark ftco_navbar ftco-navbar-light site-navbar-target" id="ftco-navbar">
    <div class="container">
      <a class="navbar-brand" href="">Port<span style="color: #ffc400">Follio</span></a>
      ...
      <div class="collapse navbar-collapse" id="ftco-nav">
        <ul class="navbar-nav nav ml-auto">
          ...
          <li class="nav-item"><a href="{{ url('/Resume') }}" class="nav-link"><span>Resume</span></a></li>
          ...
          <li class="nav-item"><a href="{{ url('/MyBlog') }}" class="nav-link"><span>My Blog</span></a></li>
