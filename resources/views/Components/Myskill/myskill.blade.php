<section class="ftco-section" id="skills-section">
  ...
  <div class="col-md-12 heading-section text-center ftco-animate">
    ...
    <p>Hello, I'm Rasel Rana, a passionate and experienced web developer with expertise in a variety of technologies. With a strong foundation in both front-end and back-end development, I specialize in creating dynamic and responsive web applications. Here are the key skills that I bring to the table:</p>
  </div>
</div>
        <div class="row">
